    ...
    public class TestRandomValues
    {
        ...
        public class TestGeneratedValues
        {
            ...
            public void TestOrderFields()
            {
                ...
                Assert.IsTrue(Repository.GetOrder(3).Product.Producer.YearOfCreation > 1950);
            }
            [TestMethod]
            public void TestProductFields()
            {
                ...
                Assert.IsTrue(Repository.GetProduct(2).Producer.YearOfCreation > 1950);
            }
            [TestMethod]
            public void TestEventFields()
            {
                ...
                Assert.IsTrue(Repository.GetEvent(2).Order.Product.Producer.YearOfCreation > 1950);
            }
            [TestMethod]
